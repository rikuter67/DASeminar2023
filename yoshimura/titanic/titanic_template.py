...
path = "/home/yoshimura/DASeminar2023/yoshimura/titanic/dataset/"
path_image = "/home/yoshimura/DASeminar2023/yoshimura/titanic/image/"

df = pd.read_csv(path + 'train.csv')
df_test = pd.read_csv(path + 'test.csv')

# df.drop(columns=['Name', 'Sex'], inplace=True)
# df_test.drop(columns=['Name', 'Sex'], inplace=True)
